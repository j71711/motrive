...
@JsonKey(name: 'vehicle_id') String get vehicleId; String get category; double get cost;@JsonKey(name: 'odometer_at_expense') int get odometer; String? get notes;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,vehicleId,category,cost,odometer,notes);

@override
String toString() {
  return 'AddExpenseModel(vehicleId: $vehicleId, category: $category, cost: $cost, odometer: $odometer, notes: $notes)';
}
...
@useResult
$Res call({
@JsonKey(name: 'vehicle_id') String vehicleId, String category, double cost,@JsonKey(name: 'odometer_at_expense') int odometer, String? notes
});
...
/// Create a copy of AddExpenseModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? vehicleId = null,Object? category = null,Object? cost = null,Object? odometer = null,Object? notes = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'vehicle_id')  String vehicleId,  String category,  double cost, @JsonKey(name: 'odometer_at_expense')  int odometer,  String? notes)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AddExpenseModel() when $default != null:
return $default(_that.vehicleId,_that.category,_that.cost,_that.odometer,_that.notes);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'vehicle_id')  String vehicleId,  String category,  double cost, @JsonKey(name: 'odometer_at_expense')  int odometer,  String? notes)  $default,) {final _that = this;
switch (_that) {
case _AddExpenseModel():
return $default(_that.vehicleId,_that.category,_that.cost,_that.odometer,_that.notes);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'vehicle_id')  String vehicleId,  String category,  double cost, @JsonKey(name: 'odometer_at_expense')  int odometer,  String? notes)?  $default,) {final _that = this;
switch (_that) {
case _AddExpenseModel() when $default != null:
return $default(_that.vehicleId,_that.category,_that.cost,_that.odometer,_that.notes);case _:
  return null;
...
class _AddExpenseModel implements AddExpenseModel {
  const _AddExpenseModel({@JsonKey(name: 'vehicle_id') required this.vehicleId, required this.category, required this.cost, @JsonKey(name: 'odometer_at_expense') required this.odometer, this.notes});
...
/// Create a copy of AddExpenseModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? vehicleId = null,Object? category = null,Object? cost = null,Object? odometer = null,Object? notes = freezed,}) {
